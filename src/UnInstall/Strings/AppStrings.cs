...
public static class AppStrings
{
    private static readonly Dictionary<string, string> En = new()
    {
        ...
        ["Welcome_Title"] = "Welcome to UnInstall!",
        ...
        ["Backup_RestorePointDescription"] = "Before uninstalling {0} (UnInstall)",
        ...
        ["DiskCleanup_DrivesTitle"] = "Drives",
        ["DiskCleanup_DriveUsedPercent"] = "{0} used",
        ...
        ["Settings_ContextMenu"] = "Add \"Uninstall with UnInstall\" to the right-click menu",
        ...
        ["ContextMenu_UninstallVerb"] = "Uninstall with UnInstall",
        ...
        ["QuickUninstall_ResultTitle"] = "UnInstall",
    ...
    private static readonly Dictionary<string, string> Vi = new()
    {
        ...
        ["Welcome_Title"] = "Chào mừng đến với UnInstall!",
        ...
        ["Backup_RestorePointDescription"] = "Trước khi gỡ {0} (UnInstall)",
        ...
        ["DiskCleanup_DrivesTitle"] = "Ổ đĩa",
        ["DiskCleanup_DriveUsedPercent"] = "Đã dùng {0}",
        ...
        ["Settings_ContextMenu"] = "Thêm \"Gỡ bằng UnInstall\" vào menu chuột phải",
        ...
        ["ContextMenu_UninstallVerb"] = "Gỡ bằng UnInstall",
    ...
    public static string DiskCleanup_DrivesTitle => Get("DiskCleanup_DrivesTitle");
    public static string DiskCleanup_DriveUsedPercent(string percent) => string.Format(Get("DiskCleanup_DriveUsedPercent"), percent);
