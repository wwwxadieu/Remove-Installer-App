...
public partial class App : Application
{
    ...
    /// <summary>
    /// Set when launched via the Explorer "Uninstall with ClearOut" context-menu
    ...
    public App()
    {
        ...
        // One-time cleanup for anyone upgrading from a beta that used an older app name: if the
        // Explorer context-menu toggle was on, its registry verbs point at a .exe path that no
