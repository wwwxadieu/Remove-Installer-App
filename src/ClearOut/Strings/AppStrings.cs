...
public static class AppStrings
{
    private static readonly Dictionary<string, string> En = new()
    {
        ...
        ["Backup_RestorePointDescription"] = "Before uninstalling {0} (ClearOut)",
        ...
        ["Settings_ContextMenu"] = "Add \"Uninstall with ClearOut\" to the right-click menu",
        ...
        ["ContextMenu_UninstallVerb"] = "Uninstall with ClearOut",
        ...
        ["QuickUninstall_ResultTitle"] = "ClearOut",
    ...
    private static readonly Dictionary<string, string> Vi = new()
    {
        ...
        ["Backup_RestorePointDescription"] = "Trước khi gỡ {0} (ClearOut)",
        ...
        ["Settings_ContextMenu"] = "Thêm \"Gỡ bằng ClearOut\" vào menu chuột phải",
        ...
        ["ContextMenu_UninstallVerb"] = "Gỡ bằng ClearOut",
